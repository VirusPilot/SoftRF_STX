...
## ATTENTION: latest T-Echo firmware has the follownig issue: power-on only works when connected to USB-C (WIP), please use https://github.com/moshe-braner/SoftRF/tree/master/software/firmware/binaries/nRF52840/SoftRF/MassStorage
