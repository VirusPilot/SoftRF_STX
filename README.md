...
## ATTENTION: only T-Beam, T-Beam S3 Supreme and T-Echo binaries are provided/tested on a regular basis, T-Echo binaries have some unresolved issues (e.g. jumping aircraft type ID)
